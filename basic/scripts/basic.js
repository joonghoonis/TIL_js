...
cart = null; //cart =''; //장바구니 비우기(삭제버튼)
console.log(cart);
console.log('------------------------');
//ES6 새로운 변수 let, const
var webStudy = 'html';
var webStudy = webStudy + 'css'; //var는 중복 구분 안함
console.log(webStudy);

let webStudy2 = 'sass';
webStudy2 = webStudy2 + 'javascript';//let은 중복구분함
console.log(webStudy2);

//const webStudy3; //undefined
//webStudy3 = 'figma'; //undefined => 'figma'
const webStudy3 = 'figma';//const는 생성%대입 동시처리 변경x
